 ...
 */
package com.github.drinkjava2.thinjdbc.util;
...
public class ThinLogger {
	...
	public ThinLogger(Class<?> targetClass) {
		if (targetClass == null)
	...
	public static ThinLogger getLog(Class<?> targetClass) {
		return new ThinLogger(targetClass);
	}
