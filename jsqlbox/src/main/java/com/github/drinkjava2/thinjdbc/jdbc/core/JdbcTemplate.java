...
package com.github.drinkjava2.thinjdbc.jdbc.core;
...
import com.github.drinkjava2.thinjdbc.dao.InvalidDataAccessApiUsageException;
import com.github.drinkjava2.thinjdbc.dao.support.DataAccessUtils;
import com.github.drinkjava2.thinjdbc.jdbc.SQLWarningException;
import com.github.drinkjava2.thinjdbc.jdbc.datasource.ConnectionProxy;
import com.github.drinkjava2.thinjdbc.jdbc.support.JdbcAccessor;
import com.github.drinkjava2.thinjdbc.jdbc.support.JdbcUtils;
import com.github.drinkjava2.thinjdbc.jdbc.support.KeyHolder;
import com.github.drinkjava2.thinjdbc.jdbc.support.nativejdbc.NativeJdbcExtractor;
import com.github.drinkjava2.thinjdbc.jdbc.support.rowset.SqlRowSet;
import com.github.drinkjava2.thinjdbc.util.Assert;
import com.github.drinkjava2.thinjdbc.util.LinkedCaseInsensitiveMap;
 ...
 * {@link com.github.drinkjava2.thinjdbc.jdbc.support.SQLExceptionTranslator}
 ...
 * @see RowMapper
 * @see com.github.drinkjava2.thinjdbc.jdbc.support.SQLExceptionTranslator
 */
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations {
	 ...
	 */
	public JdbcTemplate() {
		setDataSourceManager(DataSourceManager.jdbcDataSourceManager());
	}

	/**
	 * Construct a new JdbcTemplate, given a DataSource to obtain connections
	 * from. And use default Auto-Commit style Connection Manager
	 * <p>
	...
	/**
	 * Construct a new JdbcTemplate, given a DataSource to obtain connections
	 * from, and a DataSourceManager instance
	 * 
	 * @param dataSource
	 *            the JDBC DataSource to obtain connections from
	 * @param dm
	 *            the DataSourceManager instance
	 */
	public JdbcTemplate(DataSource dataSource, DataSourceManager dm) {
		setDataSource(dataSource);
		setDataSourceManager(dm);
		afterPropertiesSet();
	}
	 ...
	 * @see com.github.drinkjava2.thinjdbc.jdbc.SQLWarningException
	 * @see #handleWarnings
	 */
	...
	public <T> T execute(ConnectionCallback<T> action) throws DataAccessException {
		...
		Connection con = getDataSourceManager().getConnection(getDataSource());
		try {
			...
			// yet.
			getDataSourceManager().releaseConnection(con, getDataSource());
			con = null;
	 ...
	 * @see #setMaxRows
	 * @see #setQueryTimeout
	 * @see org.tinyjdbc.jdbc.datasource.DataSourceUtils#applyTransactionTimeout
	 */
	protected void applyStatementSettings(Statement stmt) throws SQLException {
		...
		getDataSourceManager().applyTimeout(stmt, getDataSource(), getQueryTimeout());
	}
