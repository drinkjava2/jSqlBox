...
import com.github.drinkjava2.thinjdbc.jdbc.CannotGetJdbcConnectionException;
import com.github.drinkjava2.thinjdbc.lang.UsesJava7;
import com.github.drinkjava2.thinjdbc.util.ClassUtils;
import com.github.drinkjava2.thinjdbc.util.NumberUtils;
...
public abstract class JdbcUtils {
	...
	private static final ThinLogger logger = ThinLogger.getLog(JdbcUtils.class);
	 ...
	 */
	public static Object extractDatabaseMetaData(DataSourceManager dsManager, DataSource dataSource, DatabaseMetaDataCallback action)
		...
		try {
			...
			throw new MetaDataAccessException(
			  ...
			  dsManager.releaseConnection(con, dataSource);
		}
	}
	 ...
	 */
	public static Object extractDatabaseMetaData(DataSourceManager dsManager,DataSource dataSource, final String metaDataMethodName)
			throws MetaDataAccessException {

		return extractDatabaseMetaData(dsManager, dataSource,
