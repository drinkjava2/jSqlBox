...
import com.github.drinkjava2.thinjdbc.jdbc.support.SqlValue;
...
public abstract class StatementCreatorUtils {
	...
	private static final ThinLogger logger = ThinLogger.getLog(StatementCreatorUtils.class);

	private static final Map<Class<?>, Integer> javaTypeToSqlTypeMap = new HashMap<Class<?>, Integer>(32);

	static {
		//YZString propVal = SpringProperties.getProperty(IGNORE_GETPARAMETERTYPE_PROPERTY_NAME);
		//shouldIgnoreGetParameterType = (propVal != null ? Boolean.valueOf(propVal) : null);
		shouldIgnoreGetParameterType=null;
