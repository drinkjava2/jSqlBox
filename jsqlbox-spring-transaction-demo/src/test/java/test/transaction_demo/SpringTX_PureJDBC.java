...
public class SpringTX_PureJDBC {
	public static DataSourceManager dm = DataSourceManager.springDataSourceManager();
	...
	public Integer queryForInteger(DataSource ds, String sql) {
		Connection con = dm.getConnection(ds);
	...
	@Test
	public void doTest() {
		System.out.println("============Testing: SpringTX_PureJDBC============");
