...
import com.github.drinkjava2.jsqlbox.function.jtransactions.grouptx.GroupShardTxTest;
import com.github.drinkjava2.jsqlbox.function.jtransactions.grouptx.GroupShardTxTest.GrpTX;
import com.github.drinkjava2.jsqlbox.gtx.GtxAOP;
...
public class GtxShardingTest {
	...
	@AOP
	public static @interface GTX {
		public Class<?> value() default GtxAOP.class;
	}
