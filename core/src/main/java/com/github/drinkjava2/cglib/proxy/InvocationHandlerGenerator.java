...
implements CallbackGenerator
{
    ...
    private static final Type INVOCATION_HANDLER =
      TypeUtils.parseType("com.github.drinkjava2.cglib.proxy.InvocationHandler");
    private static final Type UNDECLARED_THROWABLE_EXCEPTION =
      TypeUtils.parseType("com.github.drinkjava2.cglib.proxy.UndeclaredThrowableException");
