 ...
 * 
 * Usage example: long gid= new SnowflakeCreator(5L,5L, 18, 31).nextId(); <br/>
 * 
...
public class SnowflakeCreator {
	...
	/**
	 * generate an unique and incrementing gid
	 *
	 * @return gid
	 */
	public synchronized long nextId() {
		...
		if (currTimestamp < lastTimestamp) {
			throw new IllegalStateException(
					String.format("Clock moved backwards. Refusing to generate gid for %d milliseconds",
	 ...
	 * 
	 * @param gid
	 *            a snowflake gid generated by this object
	 ...
	 * information from the given gid in humanization format
	 * 
	 * @param gid
	 *            snowflake gid in Long format
	 * @return snowflake gid in String format
	 */
