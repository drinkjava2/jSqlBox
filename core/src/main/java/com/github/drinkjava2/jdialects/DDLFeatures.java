...
public class DDLFeatures {
    ...
    public static DDLFeatures copyDDLFeatures(Dialect d) {
        DDLFeatures from=d.ddlFeatures; 
        DDLFeatures to=new DDLFeatures();  
        to.addColumnSuffixString =from.addColumnSuffixString ;
        to.addFKeyRefPkeyString =from.addFKeyRefPkeyString ;
        to.addForeignKeyConstraintString =from.addForeignKeyConstraintString ;
        to.addPrimaryKeyConstraintString =from.addPrimaryKeyConstraintString ;
        to.closeQuote =from.closeQuote ;
        to.columnComment =from.columnComment ;
        to.createCatalogCommand =from.createCatalogCommand ;
        to.createMultisetTableString =from.createMultisetTableString ;
        to.createPooledSequenceStrings =from.createPooledSequenceStrings ;
        to.createSchemaCommand =from.createSchemaCommand ;
        to.createSequenceStrings =from.createSequenceStrings ;
        to.createTableString =from.createTableString ;
        to.currentSchemaCommand =from.currentSchemaCommand ;
        to.dropCatalogCommand =from.dropCatalogCommand ;
        to.dropForeignKeyString =from.dropForeignKeyString ;
        to.dropSchemaCommand =from.dropSchemaCommand ;
        to.dropSequenceStrings =from.dropSequenceStrings ;
        to.dropTableString =from.dropTableString ;
        to.hasAlterTable =from.hasAlterTable ;
        to.hasDataTypeInIdentityColumn =from.hasDataTypeInIdentityColumn ;
        to.identityColumnString =from.identityColumnString ;
        to.identityColumnStringBigINT =from.identityColumnStringBigINT ;
        to.identitySelectString =from.identitySelectString ;
        to.identitySelectStringBigINT =from.identitySelectStringBigINT ;
        to.needDropConstraintsBeforeDropTable =from.needDropConstraintsBeforeDropTable ;
        to.nullColumnString =from.nullColumnString ;
        to.openQuote =from.openQuote ;
        to.requiresParensForTupleDistinctCounts =from.requiresParensForTupleDistinctCounts ;
        to.selectSequenceNextValString =from.selectSequenceNextValString ;
        to.sequenceNextValString =from.sequenceNextValString ;
        to.supportsColumnCheck =from.supportsColumnCheck ;
        to.supportsCommentOn =from.supportsCommentOn ;
        to.supportsIdentityColumns =from.supportsIdentityColumns ;
        to.supportsIfExistsAfterConstraintName =from.supportsIfExistsAfterConstraintName ;
        to.supportsIfExistsBeforeConstraintName =from.supportsIfExistsBeforeConstraintName ;
        to.supportsPooledSequences =from.supportsPooledSequences ;
        to.supportsSequences =from.supportsSequences ;
        to.supportsTableCheck =from.supportsTableCheck ;
        to.tableTypeString =from.tableTypeString ;   
        return to;
    }
