...
public abstract class SqlBoxContextUtils {// NOSONAR
	 ...
	 */
	public static int tryInsert(SqlBoxContext ctx, Object entityBean, Object... optionItems) {// NOSONAR
	...
	public static int tryUpdate(SqlBoxContext ctx, Object entityBean, Object... optionItems) {// NOSONAR
		TableModel optionModel = SqlBoxContextUtils.findOptionTableModel(optionItems);
		TableModel model = optionModel;
		if (model == null)
			model = SqlBoxContextUtils.findEntityOrClassTableModel(entityBean);
	 ...
	 */
	public static int tryDelete(SqlBoxContext ctx, Object entityBean, Object... optionItems) {// NOSONAR
		TableModel optionModel = SqlBoxContextUtils.findOptionTableModel(optionItems);
		TableModel model = optionModel;
		if (model == null)
			model = SqlBoxContextUtils.findEntityOrClassTableModel(entityBean);
	...
	public static int countAll(SqlBoxContext ctx, Class<?> entityClass, Object... optionItems) {// NOSONAR
		TableModel optionModel = SqlBoxContextUtils.findOptionTableModel(optionItems);
		TableModel model = optionModel;
		if (model == null)
