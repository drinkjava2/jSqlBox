...
public abstract class SqlBoxContextUtils {// NOSONAR
	 ...
	 */
	public static int insert(SqlBoxContext ctx, Object entityBean) {// NOSONAR
	...
	public static <T> T load(SqlBoxContext ctx, Class<?> entityClass, Object pkeyValue) {// NOSONAR
