...
public abstract class SqlBoxContextUtils {// NOSONAR
	 ...
	 */
	public static int insertEntity(SqlBoxContext ctx, Object entityBean, Object... optionItems) {// NOSONAR
	...
	public static int updateEntity(SqlBoxContext ctx, Object entityBean, Object... optionItems) {// NOSONAR
		TableModel optionModel = SqlBoxContextUtils.findOptionTableModel(optionItems);
		TableModel model = optionModel;
		if (model == null)
			model = SqlBoxContextUtils.findEntityOrClassTableModel(entityBean);
	 ...
	 */
	public static int deleteEntity(SqlBoxContext ctx, Object entityBean, Object... optionItems) {// NOSONAR
		TableModel optionModel = SqlBoxContextUtils.findOptionTableModel(optionItems);
		TableModel model = optionModel;
		if (model == null)
			model = SqlBoxContextUtils.findEntityOrClassTableModel(entityBean);
	...
	@SuppressWarnings("unchecked")
	public static <T> T loadEntity(SqlBoxContext ctx, Object entityBean, Object... optionItems) {// NOSONAR
		TableModel optionModel = SqlBoxContextUtils.findOptionTableModel(optionItems);
		TableModel model = optionModel;
		if (model == null)
			model = SqlBoxContextUtils.findEntityOrClassTableModel(entityBean);
	...
	public static int countAllEntity(SqlBoxContext ctx, Class<?> entityClass, Object... optionItems) {// NOSONAR
		TableModel optionModel = SqlBoxContextUtils.findOptionTableModel(optionItems);
		TableModel model = optionModel;
		if (model == null)
	...
	public static <T> T loadById(SqlBoxContext ctx, Object entityOrClass, Object idOrIdMap, Object... optionItems) {// NOSONAR
		...
		return loadEntity(ctx, bean, optionItems);
	}
